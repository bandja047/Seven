...
{
    partial class DataCategorieView
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "LISTES DES CATEGORIES";
            ...
            // LvCategorie
            // 
            LvCategorie.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            LvCategorie.BorderStyle = BorderStyle.None;
            LvCategorie.Columns.AddRange(new ColumnHeader[] { ColHeadReference, ColHeadName, ColHeadDescription, ColHeadParent });
            LvCategorie.ForeColor = Color.Black;
            LvCategorie.FullRowSelect = true;
            LvCategorie.Location = new Point(12, 59);
            LvCategorie.Name = "LvCategorie";
            LvCategorie.Size = new Size(781, 430);
            LvCategorie.TabIndex = 6;
            LvCategorie.UseCompatibleStateImageBehavior = false;
            LvCategorie.View = View.Details;
            LvCategorie.Resize += lvArticle_Resize;
            // 
            // ColHeadReference
            // 
            ...
            Controls.Add(LvCategorie);
            Controls.Add(BtnModifier);
            Controls.Add(BtnDelete);
            Controls.Add(BtnAjouter);
            Controls.Add(panel1);
            Name = "DataCategorieView";
        ...
        private ColumnHeader ColHeadParent;
    }
}
